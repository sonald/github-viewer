...
function Repo(user, name) {
    ...
    Object.defineProperty(this, 'released', {
        get: function() { return !!this._released; },
        set: function(val) { this._released = !!val; },
        enumerable: false
    });

    function cmdDecorator(cmd) {
        return function() {
            var args = arguments, len = args.length;
            if (this.released) {
                debug('decorated');
                if (len && typeof args[len-1] === 'function') {
                    return args[len-1]("Repo has been released");
                }
            }

            return cmd.apply(this, [].slice.call(args));
        };
    }

    for (var cmd in this) {
        if (typeof this[cmd] === 'function') {
            this[cmd] = cmdDecorator(this[cmd]);
        }
    }
}
